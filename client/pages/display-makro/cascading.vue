...
<template>
  <b-card>
    ...
    <diagram-sasaran v-else :data="sasaranStrategisRpjmd" :satkerList="satkerList" :satkerId="filter.satuan_kerja_id" max-level="2" :key="componentKey" :showSwitchIconCapaian="true" />
  </b-card>
</template>
