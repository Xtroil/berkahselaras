    ...
    <b-table-simple sticky-header="calc(100vh - 100px)" :aria-busy="isBusy" hover responsive bordered striped>
      <b-thead class="text-center align-middle" head-variant="info">
        ...
        <b-tr>
          ...
          <b-th class="align-top" style="top:79px;"><span style="min-width: 125px;display: inline-block;">Capaian Tahun {{ $helper.getTahunKinerja() }} Terhadap Target Akhir RJMD (%)</span></b-th>
