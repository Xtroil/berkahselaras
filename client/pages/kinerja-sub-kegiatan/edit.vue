            ...
            <b-col xs md="4">
              <b-form-group :label="`Eviden Kinerja ${month[1]}`" label-class="font-weight-bold" :label-for="`eviden-${month[0]}`">
                <div class="d-flex" style="align-items: center;">
                  <b-form-file :id="`eviden-${month[0]}`" :ref="`eviden-${month[0]}`" @change="validateEvidenBulanan($event, month[0])" placeholder="Pilih berkas" accept=".pdf"></b-form-file>
                  <b-button @click="resetEviden(month[0])" variant="outline-danger" size="sm" class="ml-2 rounded-circle" title="Hapus" style="height: fit-content;">
