...
/**
 * App\Models\Ekinerja\IkiBulanan
 *
 * @property int $id
 ...
 * @property mixed|null $attachment_lapor
...
namespace App\Models\Ekinerja{
/**
 * App\Models\Ekinerja\SasaranKinerja
 *
 * @property int $id
...
namespace App\Models\Ekinerja{
/**
 * App\Models\Ekinerja\VPegawaiData
 *
...
/**
 * App\Models\IndikatorSasaranStrategis
 *
 * @property int $id
 * @property int $nomor
...
namespace App\Models{
/**
 * App\Models\IndikatorSubKegiatan
 *
 * @property int $id
...
namespace App\Models{
/**
 * App\Models\KamusIndikatorFungsional
 *
 * @property int $id
 * @property int $tahun_mulai
...
namespace App\Models{
/**
 * App\Models\KamusIndikatorFungsionalManual
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property int $satuan_kerja_id
...
namespace App\Models{
/**
 * App\Models\KamusIndikatorFungsionalPengampu
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property int $satuan_kerja_id
...
namespace App\Models{
/**
 * App\Models\KamusIndikatorFungsionalPengampuJF
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property int $satuan_kerja_id
...
namespace App\Models{
/**
 * App\Models\KamusIndikatorFungsionalSasaran
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property int $satuan_kerja_id
...
namespace App\Models{
/**
 * App\Models\KamusIndikatorValidasiBappeda
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property int $satuan_kerja_id
...
namespace App\Models{
/**
 * App\Models\KinerjaTidakTercapai
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property string $notable_type
...
/**
 * App\Models\LKE\CatatanRekomendasi
 *
 * @property int $id
 * @property int $satuan_kerja_id
 * @property int $tahun_kinerja
...
namespace App\Models\LKE{
/**
 * App\Models\LKE\PenilaianKomponen
 *
 * @property int $id
...
namespace App\Models{
/**
 * App\Models\NilaiJenjangKinerja
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property int $satuan_kerja_id
...
namespace App\Models{
/**
 * App\Models\PerubahanJumlahOutput
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property int $satuan_kerja_id
...
namespace App\Models{
/**
 * App\Models\PerubahanJumlahOutputV2
 *
 * @property int $id
 * @property int $tahun_kinerja
 * @property int $satuan_kerja_id
...
namespace App\Models{
/**
 * App\Models\SasaranStrategisRpjmd
 *
 * @property int $id
 * @property int $satuan_kerja_id
 * @property int $sasaran_strategis_id
...
namespace App\Models{
/**
 * App\Models\SolusiKinerja
 *
 * @property int $id
 * @property int $masalah_id
 * @property-write string $masalah_type
 * @property int $solusi_id
 * @property-write string $solusi_type
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
...
namespace App\Models{
/**
 * App\Models\VStrukturOrganisasi
 *
 * @property string $satuan_kerja_id
 * @property string|null $satuan_kerja_nama
...
namespace App\Models{
/**
 * App\Models\ValidasiPerencanaan
 *
 * @property int $id
 * @property int $satuan_kerja_id
 * @property int $tahun_kinerja
